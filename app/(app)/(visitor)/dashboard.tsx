...
export default function VisitorDashboardScreen() {
  ...
  const loadData = async () => {
    if (user) {
      const requests = await fetchRequestsByVisitor(user.id);
  ...
  const handleViewAllRequests = () => {
    router.push('/(app)/(visitor)/requests');
  };
  
  const handleViewNotifications = () => {
    router.push('/(app)/(visitor)/notifications');
  };
      ...
      >
        ...
        <View style={styles.newRequestCard}>
          <View style={styles.newRequestContent}>
            <Text style={styles.newRequestTitle}>Create a Visit Request</Text>
            <Text style={styles.newRequestText}>
              Need to visit a property? Create a new request to get approval from the owner.
            </Text>
          </View>
          <Button
            title="New Request"
            ...
            icon={<PlusCircle size={18} color="#FFFFFF" style={styles.newRequestIcon} />}
          />
        </View>
        ...
        <View style={styles.section}>
          ...
          {pendingRequests.length > 0 ? (
            ...
            <EmptyState
              ...
              message="You don't have any pending visit requests at the moment."
        ...
        <View style={styles.section}>
          ...
          {recentRequests.length > 0 ? (
            ...
            <EmptyState
              ...
              message="Your recent visit activity will appear here."
              icon={<ClipboardList size={48} color={Colors.subtext} />}
            />
          )}
        </View>
